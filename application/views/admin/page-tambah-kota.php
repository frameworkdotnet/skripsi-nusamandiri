									...
									<div class="controls">
										<select name="provinsi_id">
											...
											foreach ($provinsi as $provinsi) :
												echo '<option value="'.$provinsi['provinsi_id'].'" '.set_select('provinsi_id', $provinsi['provinsi_id']).' >'.$provinsi['nama'].'</option>';
											endforeach; 
											?>
										</select>
						...
						<div class="page-header">
							...
							<fieldset>
								<div class="control-group <?php echo (form_error('ongkos_kirim')) ? 'error' : ''; ?>">
									<div class="controls">
										<input class="input-large focused" name="ongkos_kirim" type="text" value="<?php echo set_value('ongkos_kirim'); ?>">
