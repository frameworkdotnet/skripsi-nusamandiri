						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
							<fieldset>
								<div class="control-group <?php echo (form_error('nama')) ? 'error' : ''; ?>">
									...
									<div class="controls">
										<input class="input-xlarge focused" name="nama" type="text" value="<?php echo ($this->input->post()) ? set_value('nama') : $provinsi['nama']; ?>">
										<input class="input-xlarge focused" name="provinsi_id" type="hidden" value="<?php echo $provinsi['provinsi_id']; ?>">
