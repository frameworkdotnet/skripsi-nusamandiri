						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
							<fieldset>
								<div class="control-group <?php echo (form_error('nama')) ? 'error' : ''; ?>">
									...
									<div class="controls">
										<input class="input-xlarge focused" name="nama" type="text" value="<?php echo ($this->input->post()) ? set_value('nama') : $kategori['nama']; ?>">
										<input class="input-xlarge focused" name="kategori_id" type="hidden" value="<?php echo $kategori['kategori_id']; ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
									  <label class="checkbox">
										<input type="checkbox" name="status" value="1" <?php echo ($kategori['status']) ? 'checked' : ''; ?>>
										Aktif
									  </label>
									</div>
								</div>
						...
						<div class="page-header">
							...
							<fieldset>
								<div class="control-group <?php echo (form_error('deskripsi')) ? 'error' : ''; ?>">
									<div class="controls">
										<textarea rows="8" class="input-xxlarge" name="deskripsi"><?php echo $kategori['deskripsi']; ?></textarea>
